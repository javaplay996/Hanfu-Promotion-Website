  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">汉服推广网站注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201112/da0327df9671423b9dafef93657c7514.jpg");
		height: 100vh;
		...
		.login-form {
			...
			.rgs-form {
				...
				.btn {
					...
					border-width: 0px;
					border-style: solid;
					border-color: rgba(251, 0, 29, 0.73);
					border-radius: 4px;
