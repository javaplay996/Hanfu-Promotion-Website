<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="票券编号" prop="piaoquanbianhao">
            <el-input v-model="ruleForm.piaoquanbianhao" 
                placeholder="票券编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.piaoquanbianhao" label="票券编号" prop="piaoquanbianhao">
              <el-input v-model="ruleForm.piaoquanbianhao" 
                placeholder="票券编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="票券名称" prop="piaoquanmingcheng">
          <el-input v-model="ruleForm.piaoquanmingcheng" 
              placeholder="票券名称" clearable  :readonly="ro.piaoquanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="票券名称" prop="piaoquanmingcheng">
              <el-input v-model="ruleForm.piaoquanmingcheng" 
                placeholder="票券名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	piaoquanbianhao : false,
	piaoquanmingcheng : false,
	beizhu : false,
	yonghuzhanghao : false,
	yonghuxingming : false,
      },
      ruleForm: {
        piaoquanbianhao: this.getUUID(),
        piaoquanmingcheng: '',
        beizhu: '',
        yonghuzhanghao: '',
        yonghuxingming: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='piaoquanbianhao'){
            this.ruleForm.piaoquanbianhao = obj[o];
	    this.ro.piaoquanbianhao = true;
            continue;
          }
          if(o=='piaoquanmingcheng'){
            this.ruleForm.piaoquanmingcheng = obj[o];
	    this.ro.piaoquanmingcheng = true;
            continue;
          }
          if(o=='beizhu'){
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springboot68bv8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huodongpiaoquan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huodongpiaoquanCrossAddOrUpdateFlag = false;
                  this.parent.search();
