<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="音乐" prop="yinle">
          <file-upload
          tip="点击上传音乐"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.yinle?ruleForm.yinle:''"
          @change="yinleUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.yinle" label="音乐" prop="yinle">
            <el-button type="text" size="small" @click="download(ruleForm.yinle)">预览</el-button>
          </el-form-item>
        </div>    
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="文章" prop="wenzhang">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.wenzhang" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wenzhang" label="文章" prop="wenzhang">
                    <span v-html="ruleForm.wenzhang"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='wenzhang'){
            this.ruleForm.wenzhang = obj[o];
	    this.ro.wenzhang = true;
            continue;
          }
          if(o=='yinle'){
            this.ruleForm.yinle = obj[o];
	    this.ro.yinle = true;
            continue;
          }
          if(o=='fabushijian'){
	...
	this.ruleForm.wenzhang = this.ruleForm.wenzhang.replace(reg,'../../../springboot68bv8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tuwendongtaiqu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuwendongtaiquCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    yinleUploadChange(fileUrls) {
	this.ruleForm.yinle = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
